...
export default function page() {
  ...
  return (
    <section className='py-4 w-full max-w-2xl space-y-10'>
      <div className='space-y-3'>
        <h1 className={`lg:text-3xl text-blue-600 border-b-1 border-blue-600 border-solid`}>Instructor</h1>
        {loading ? <Spinner className='text-center w-full'/>:<PeopleList data={instructor} />}
      </div>
      <div className='space-y-3'>
        <h1 className={`lg:text-3xl flex justify-between items-end text-blue-600 border-b-1 border-blue-600 border-solid`}>Student <span className='text-lg'>{student?.length} Student</span></h1>
